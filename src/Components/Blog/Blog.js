...
const Blog = () => {
    ...
    return (
        <div id='Blog'>
            <h1 className='bg-success p-5'><marquee><h2 className='text-light fw-bold'><i>Client Here...</i></h2></marquee></h1>
            <h1>Client Says:</h1>
            ...
            <div className='border borde-3 p-3 m-2'>
                ...
                <button className='btn btn-success'>Subscribe Button</button>
            </div>
        </div>
    );
};
